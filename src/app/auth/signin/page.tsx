      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            {/* Google Sign In Button - แสดงเฉพาะเมื่อไม่ใช่ LINE app */}
            {!isInLineClient && (
              <button
            ...
            {/* Divider - แสดงเฉพาะเมื่อมีทั้ง Google และ LINE */}
            {(!isInLineClient && (isInLineClient || isLiffReady)) && (
